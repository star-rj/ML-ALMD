...
if __name__ == '__main__':
    ...
    # 写入csv文件路径
    csv_path = '~/codes/mmdetection/csv'
    ...
    arg_pth_dict = {
        "M": {
            "arg_path": "~/codes/mmdetection/configs/M/cascade_rcnn_r101_M_linan_dataset_apl.py",
            # "model_path": "~/codes/mmdetection/work_dirs/cascade_rcnn_r101_M_linan_dataset_apl/epoch_19.pth"
            "model_path": "~/codes/mmdetection/work_dirs/cascade_rcnn_r101_M_linan_dataset_apl/cascade_rcnn_r101_M_linan_dataset_apl__epoch_19.pth"
        },
        "POX": {
            "arg_path": "~/codes/mmdetection/configs/POX/cascade_rcnn_r101_POX_concat.py",
            # "model_path": "~/codes/mmdetection/work_dirs/cascade_rcnn_r101_POX_concat/epoch_24.pth"
            "model_path": "~/codes/mmdetection/work_dirs/cascade_rcnn_r101_POX_concat/cascade_rcnn_r101_POX_concat__epoch_24.pth"
        },
        "RJBY_POX":{
            "arg_path":"~/codes/mmdetection/pth/POX/pox_refactor.py",
            "model_path":"~/codes/mmdetection/pth/POX/pox_refactor.pth",
        },
        "CE":{
            "arg_path": '~/codes/mmdetection/pth/CE/ce_swin_T_1025.py',
            "model_path": "~/codes/mmdetection/pth/CE/ce_swin_T_1025.pth"
        },
    }
    # 
